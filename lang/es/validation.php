...
return [
    ...
    */
    ...
    |
    | Keyed by the BARE property name (no "form." prefix): Livewire's
    | HandlesValidation strips a Form Object's property prefix (e.g.
    | "waiverForm.courseId" -> "courseId") before doing this lookup, so
    | one entry here covers every Form across the app that has a property
    | of that name — see vendor/livewire/livewire/src/Features/
    | SupportValidation/HandlesValidation.php.
    |
    */
    ...
    'attributes' => [
        ...
        'type' => 'tipo',
        'courseId' => 'curso',
        'requiredCourseId' => 'requisito no cumplido',
        'originInstitution' => 'institución de origen',
        'externalCourse' => 'nombre del curso externo',
        'supportDocument' => 'documento de soporte',
        'externalProgramFile' => 'programa del curso externo',
        'gradeCertificationFile' => 'certificación de calificación',
        'institutionProofFile' => 'constancia de la institución',
        'order' => 'orden',
        'minimumGrade' => 'nota mínima',
        'minimumAccumulated' => 'mínimo acumulado',
        'active' => 'activo',
